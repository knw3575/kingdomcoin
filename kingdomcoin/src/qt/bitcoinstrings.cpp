...
QT_TRANSLATE_NOOP("bitcoin-core", "Listen for connections on <port> (default: 9381 or testnet: 19381)"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "SSL options: (see the Kingdomcoin Wiki for SSL setup instructions)"),
