...
import com.uncoin.wallet2.ui.InputParser.BinaryInputParser;
import com.uncoin.wallet2.ui.InputParser.StringInputParser;
import com.uncoin.wallet2.util.CrashReporter;
import com.uncoin.wallet2.util.Crypto;
import com.uncoin.wallet2.util.GenericUtils;
import com.uncoin.wallet2.util.HttpGetThread;
import com.uncoin.wallet2.util.IntentIntegrator;
import com.uncoin.wallet2.util.IntentResult;
import com.uncoin.wallet2.util.Nfc;
	...
	protected void onCreate(final Bundle savedInstanceState)
	{
		...
		handleIntent(getIntent());
			...
			try {
				...
				menu_icon.setOnClickListener(new ImageView.OnClickListener() {
