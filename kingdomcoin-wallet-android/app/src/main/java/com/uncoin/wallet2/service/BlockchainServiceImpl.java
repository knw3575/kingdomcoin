...
package com.uncoin.wallet2.service;
...
import com.uncoin.wallet2.WalletBalanceWidgetProvider;
import com.uncoin.wallet2.ui.WalletActivity;
import com.uncoin.wallet2.util.CrashReporter;
import com.uncoin.wallet2.util.GenericUtils;
import com.uncoin.wallet2.util.ThrottlingWalletChangeListener;
					...
					public InetSocketAddress[] getPeers(final long timeoutValue, final TimeUnit timeoutUnit) throws PeerDiscoveryException
					{
                        try {
                            dbPeerDiscovery = new LitcoinPeerDBDiscovery(Constants.NETWORK_PARAMETERS,
                                    getFileStreamPath("meshcoin.peerdb"), peerGroup);
