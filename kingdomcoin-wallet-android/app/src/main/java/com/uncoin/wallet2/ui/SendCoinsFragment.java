...
import com.uncoin.wallet2.AddressBookProvider;
import com.uncoin.wallet2.Constants;
import com.uncoin.wallet2.ExchangeRatesProvider;
import com.uncoin.wallet2.ExchangeRatesProvider.ExchangeRate;
import com.uncoin.wallet2.WalletApplication;
import com.uncoin.wallet2.integration.android.BitcoinIntegration;
import com.uncoin.wallet2.offline.SendBluetoothTask;
import com.uncoin.wallet2.ui.InputParser.StringInputParser;
import com.uncoin.wallet2.util.GenericUtils;
import com.uncoin.wallet2.util.IntentIntegratorSupportV4;
import com.uncoin.wallet2.util.IntentResult;
import com.uncoin.wallet2.util.WalletUtils;
...
public final class SendCoinsFragment extends SherlockFragment
{
	...
	public View onCreateView(final LayoutInflater inflater, final ViewGroup container, final Bundle savedInstanceState)
	{
		...
		localAmountView.setAmount(wallet.getBalance(), false);
	...
	private void validateAmounts(final boolean popups)
	{
		...
		try {
			amount = amountCalculatorLink.getAmount();//.divide(new BigInteger("100000000"));
		} catch (Exception ex) {
	...
	private void popupAvailable(@Nonnull final View anchor, @Nonnull final BigInteger available, @Nonnull final BigInteger pending)
	{
		...
		//kun7788
		viewAvailable.setAmount(available);//.multiply(new BigInteger("100000000"));
		...
		alert.setTitle("available : "+ available);
		alert.show();*/
	...
	private void handleGo()
	{
		...
		// create spend
		BigInteger amount = amountCalculatorLink.getAmount();//.divide(new BigInteger("100000000"));
        ...
        if(baseSendRequest.emptyWallet) {
            ...
            new AlertDialog.Builder(SendCoinsFragment.this.getActivity())
                    ...
                    .setMessage("A fee of " +
                            GenericUtils.formatValue2(origAmount.subtract(amount), Constants.BTC_MAX_PRECISION, 0) +
