...
public class GenericUtils
{
	...
	public static String formatValue2(@Nonnull final BigInteger value, final int precision, final int shift)
	{
		return formatValue2(value, "", "-", precision, shift);
	}
	...
	public static String formatValue2(@Nonnull final BigInteger value, @Nonnull final String plusSign, @Nonnull final String minusSign,
									 final int precision, final int shift)
	{
		...
		final long coins = absValue;
		return String.format(Locale.US, "%s%d.00", sign, coins);
	}
