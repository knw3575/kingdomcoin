...
public class Constants
{
	...
	private static final String FILENAME_NETWORK_SUFFIX = "kingdomcoin";
	...
	public static final String EXTERNAL_WALLET_KEY_BACKUP = "kingdomcoin-wallet-keys";
	...
	public static final String MIMETYPE_TRANSACTION = "application/x-kingdomtx";

	//public static final int MAX_NUM_CONFIRMATIONS = 7;
	public static final int MAX_NUM_CONFIRMATIONS = 2;
	public static final String USER_AGENT = "Kingdomcoin Wallet";
	...
	public static final String CURRENCY_CODE_BTC = "KDC";
	public static final String CURRENCY_CODE_MBTC = "mKDC";
	...
	public static final String REPORT_EMAIL = "finedv@naver.com";
	...
	public static final int MEMORY_CLASS_LOWEND = 480;
